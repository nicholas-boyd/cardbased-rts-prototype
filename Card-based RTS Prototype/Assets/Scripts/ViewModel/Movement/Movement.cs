...
public abstract class Movement : MonoBehaviour {
    public const string MovementBegunNotification = "MOVEMENT_IN_PROGRESS";
    public const string MovementCompleteNotification = "MOVEMENT_COMPLETE";
	...
	protected virtual void Filter (List<Tile> tiles) {
		for (int i = tiles.Count - 1; i >= 0; --i)
			if (tiles[i].content != null || tiles[i] == null)
				tiles.RemoveAt(i);
	}
