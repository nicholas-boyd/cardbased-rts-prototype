...
public class Panel : MonoBehaviour {
    ...
    public void AddPosition(string name, TextAnchor myAnchor, TextAnchor parentAnchor, Vector2 offset) {
        Position p = new Position(name, myAnchor, parentAnchor, offset);
        positionMap[p.name] = p;
    }
